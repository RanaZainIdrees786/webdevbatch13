  ...
  <a href="/home">Home Page</a>
    <form action="/login" method="POST">
      ...
      <div class="form-input">
        <label for="" style="font-family: Arial, Helvetica, sans-serif"
          >Name</label
        >
      ...
      <div class="form-input">
        ...
        <input name='password' required  value='pak12345' type="password" placeholder="must contain at least 8 character"  minlength="8" maxlength="15"/>
      </div>
